 ...
 * Created on Aug 23, 2023, 8:43 PM
 */
...
int main() { 
    ...
    while(1){
        ret = ADC_Get_Conversion_Blocking(&adc_1, ADC_CHANNEL0_AN0, &adc_res_1);
        ret = ADC_Get_Conversion_Blocking(&adc_1, ADC_CHANNEL1_AN1, &adc_res_2);
        ret = ADC_Get_Conversion_Blocking(&adc_1, ADC_CHANNEL2_AN2, &adc_res_3);
        ret = ADC_Get_Conversion_Blocking(&adc_1, ADC_CHANNEL3_AN3, &adc_res_4);
